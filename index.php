    ...
    <div class="container-fluid">
        ...
        <section class="section">
            ...
            <div class="row">
                ...
                <!--First column-->
                <div class="col-lg-4 col-md-6 m-b-r wow fadeInLeft" data-wow-delay="0.4s">
                ...
                <!--Second column-->
                <div class="col-lg-4 col-md-6 m-b-r wow fadeInLeft" data-wow-delay="0.3s">
                ...
                <!--Third column-->
                <div class="col-lg-4 col-md-6 m-b-r wow fadeInLeft" data-wow-delay="0.2s">
        ...
        <section class="section">
            ...
            <div class="row">
                ...
                <!--First column-->
                <div class="col-lg-4 col-md-6 m-b-r wow fadeInRight" data-wow-delay="0.2s">
                ...
                <!--Second column-->
                <div class="col-lg-4 col-md-6 m-b-r wow fadeInRight" data-wow-delay="0.3s">
                ...
                <!--Third column-->
                <div class="col-lg-4 col-md-6 m-b-r wow fadeInRight" data-wow-delay="0.4s">
        ...
        <section class="section">
            ...
            <div class="row">
                ...
                <!--First column-->
                <div class="col-lg-3 col-md-6 m-b-r wow fadeInUp" data-wow-delay="0.2s">
                ...
                <!--Second column-->
                <div class="col-lg-3 col-md-6 m-b-r wow fadeInDown" data-wow-delay="0.2s">
